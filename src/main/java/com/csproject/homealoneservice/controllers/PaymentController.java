...
public class PaymentController {
    ...
    public ResponseEntity<List<PaymentSummaryReportDTO>> paymentSummary(@RequestParam("mid")int mid, @RequestParam("dateFrom")String dateFrom, @RequestParam("dateTo")String dateTo){
//        List<PaymentSummaryDTO> payments=  paymentService.paymentSummary(mid,dateFrom,dateTo);

                return new ResponseEntity<>(paymentService.paymentSummary(mid,dateFrom,dateTo), HttpStatus.OK);
